...
\frontmatter
        ...
        \tableofcontents
        {% if cookiecutter.list_of_figures=="n" %}%{% endif %}\listoffigures
        {% if cookiecutter.list_of_tables=="n" %}%{% endif %}\listoftables
        {% if cookiecutter.list_of_algorithms=="n" %}%{% endif %}\listofalgorithms
